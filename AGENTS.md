...
For the complete reusable workflow, load [plugins/vera/skills/vera-search/SKILL.md](plugins/vera/skills/vera-search/SKILL.md).
Its [CLI reference](plugins/vera/skills/vera-search/references/cli-reference.md) documents every flag,
...
portable [agent skill](plugins/vera/skills/vera-search/SKILL.md), and documentation-contract tests
...
the relevant files under [plugins/vera/skills/vera-search/references](plugins/vera/skills/vera-search/references).

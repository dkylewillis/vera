...
from vera_ingest.markdown import (
    ensure_registered as ensure_markdown_pipeline_registered,
)
...
# metadata; the sidecar hard-depends on the default PDF and Markdown pipelines
# and the bundled OpenAI embedder.

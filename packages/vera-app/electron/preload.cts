...
contextBridge.exposeInMainWorld('vera', {
  ...
  cancelRequest: (requestId: string) => ipcRenderer.invoke('vera:cancelRequest', requestId),
  ...
  pathExists: (targetPath: string) => ipcRenderer.invoke('vera:pathExists', targetPath),
  showInFolder: (targetPath: string) => ipcRenderer.invoke('vera:showInFolder', targetPath),

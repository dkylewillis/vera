...
const IPC_CHANNELS: typeof IpcChannels = {
  ...
  openConvertLog: 'vera:openConvertLog',
  showConvertLogFolder: 'vera:showConvertLogFolder',
  getConvertLogPath: 'vera:getConvertLogPath',
...
contextBridge.exposeInMainWorld('vera', {
  ...
  saveEnvSecret: (name: string, value: string) => ipcRenderer.invoke(IPC_CHANNELS.saveEnvSecret, name, value),
  clearEnvSecret: (name: string) => ipcRenderer.invoke(IPC_CHANNELS.clearEnvSecret, name),
  ...
  openConvertLog: () => ipcRenderer.invoke(IPC_CHANNELS.openConvertLog),
  showConvertLogFolder: () => ipcRenderer.invoke(IPC_CHANNELS.showConvertLogFolder),
  getConvertLogPath: () => ipcRenderer.invoke(IPC_CHANNELS.getConvertLogPath),

...
const pyinstallerArgs = [
  ...
  "vera_mcp.server",
  "--hidden-import",
  "vera_mcp.source_viewer",
  "--hidden-import",
  "vera_mcp.access_policy",
  "--hidden-import",
  "mcp",
  "--hidden-import",
  "onnxruntime",
  ...
  "mcp",
  "--add-data",
  `${path.join(repoRoot, "packages", "vera-mcp", "src", "vera_mcp", "ui")}${path.delimiter}vera_mcp/ui`,
...
const sourcePaths = [
  ...
  path.join(repoRoot, "packages", "vera-mcp", "src"),
];
const env = {
  ...process.env,

...
- Convert supports PDF, native Markdown, and (with Docling) search-only
  DOCX/PPTX/XLSX/HTML. Visual grounding for Office/HTML, richer Markdown
  preview, typed region `kind` values for sheets and slides, and later
  locators are in

...
| [vera-ingest-docling](vera-ingest-docling.md) | `vera-ingest-docling` | `import vera_ingest_docling` | Optional Docling HybridChunker ingest (bundled in the desktop sidecar) |

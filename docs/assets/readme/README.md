...
| `provider-setup.png` | The **Settings** dialog on the **LLM Providers** section, with a provider, empty/redacted **API Key** field, enabled model, and **Set as active** control. | Step 2–4 of desktop quick start. |
| `convert-single-pdf.png` | The **Convert** view with a PDF or Markdown selection / directory conversion. | Conversion feature card and quick start. |
